...
public class Parser {
	...
	private Document document() {
		...
		try {
			...
			jjtree.closeNodeScope(document);
		}
		return document;
	...
	private boolean jj_3R_209() {
		if (jj_scan_token(CHAR_SEQUENCE))
			return true;
		return false;
	}
